...
curl -s -X POST http://127.0.0.1:3000/api/v1/gst/mobility/sync -H "Content-Type: application/json" -d "{\"vehicle_id\": \"VEH-001\", \"driving_efficiency\": \"0.85\", \"carbon_footprint\": \"2.5\", \"sustainability_score\": \"0.90\"}"
echo.

echo 🚙 Testando GuardDrive Vehicle Info...
curl -s http://127.0.0.1:3000/api/v1/gst/mobility/vehicle/VEH-001
echo.
...
curl -s -X POST http://127.0.0.1:3000/api/v1/gst/cross-platform/transfer -H "Content-Type: application/json" -d "{\"from_platform\": \"mobility\", \"to_platform\": \"guardflow\", \"amount\": \"100\"}"
echo.
