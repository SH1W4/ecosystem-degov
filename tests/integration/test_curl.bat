...
curl -s -X POST http://127.0.0.1:3000/ai/analyze/text ^
  -H "Content-Type: application/json" ^
  -d "{\"analysis_type\":\"sentiment\",\"text\":\"This is a positive message about sustainability\"}"
echo.
echo.

echo 🖼️ Testando AI Image Analysis...
curl -s -X POST http://127.0.0.1:3000/ai/analyze/image ^
  -H "Content-Type: application/json" ^
  -d "{\"analysis_type\":\"sustainability\",\"image_url\":\"https://example.com/sustainable-product.jpg\"}"
echo.
echo.
